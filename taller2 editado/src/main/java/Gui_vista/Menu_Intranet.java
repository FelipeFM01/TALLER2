...
public class Menu_Intranet extends JFrame{
    ...
    public Menu_Intranet(){
        ...
        setSize(1200,800); //  tamaño ventana
        ...
        final RegistrarEstudiante registrarEstudiante = new RegistrarEstudiante("Registrar"); // comunicar esta clase con la de registro vehiculo
        ...
        final BuscarEstudiante buscarEstudiante = new BuscarEstudiante(titulo); // comunicar esta clase con la de buscar vehiculo
